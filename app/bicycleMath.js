...
export function computeFrontFrame(frontAxle, headTubeLength, headTubeAngle, forkLength, forkOffset,
        headsetBottomHeight) {
...
function computeWheelFlopRadius(forkTrail, headTubeAngleRad) {
    return forkTrail * Math.cos(headTubeAngleRad) * Math.sin(headTubeAngleRad);
}

export function computeWheelFlop(forkTrail, headTubeAngle) {
    return computeWheelFlopRadius(forkTrail, degToRad(headTubeAngle));
}
